...
(() => {
  ...
  const cio = new IntersectionObserver((entries) => {
    entries.forEach(en => {
      ...
      const tick = () => { cur = Math.min(target, cur + step); el.textContent = cur.toLocaleString("ru-RU") + suffix;
  ...
  const CASES = [
    ...
    { id: "mirkino", tag: "Кинофестиваль", title: "Молодёжный кинофестиваль «Мир кино»",
      ...
      desc: "Социальный проект «Загляни в яркий мир кино с изнанки» — бесплатный кинофестиваль для молодёжи и семей. Показы короткометражек и авторского кино с обсуждением, 9 часов бесплатных образовательных программ, мастер-классы по режиссуре, монтажу и применению ИИ в кино, встречи с профессионалами индустрии, красная дорожка и детские творческие активности. Работу события обеспечивали 29 волонтёров в 13 функциональных зонах.",
      metrics: [["760", "посетителей"], ["526", "детей и подростков"], ["29", "волонтёров"], ["2 млн", "медиаохват"]],
      gallery: ["assets/img/mirkino-2.jpg", "assets/img/mirkino-3.jpg", "assets/img/mirkino-4.jpg", "assets/img/mirkino-5.jpg"],
      media: "Спикеры: Саид Нигматулин (ИИ в кинопроизводстве) · Алексей Зуев (фильм «Жизнь с доставкой») · 40 приглашённых экспертов · 29 партнёров · 19 публикаций · репортаж на REN.TV" },
    { id: "poigraem", tag: "Спорт и семья", title: "Футбольный фестиваль «Приходи, поиграем!»",
      sub: "9 ноября 2024 · Москва, ул. Нижние Мневники, 10",
      cover: "assets/img/poigraem.jpg",
      desc: "Семейный футбольный фестиваль для детей и взрослых: параллельные турниры детских и взрослых команд и финальный дружеский матч победителей. Профессиональное поле, квалифицированные арбитры и турнир пенальти; зона активных развлечений (большой батут, надувные ворота, футбол в валенках), сцена с аниматорами и ЗОЖ-программой, фотозоны и тёплые зоны с едой. Ведущий — шоумен Василий Рассказов-Николаев.",
      metrics: [["900+", "участников"], ["42 000 ₽", "собрано на инвалидную коляску"], ["22", "человека в команде"], ["2,6 млн ₽", "объём расходов проекта"]],
      gallery: ["assets/img/poigraem-2.jpg", "assets/img/poigraem-3.jpg", "assets/img/poigraem-4.jpg", "assets/img/poigraem-5.jpg"],
      media: "Партнёр — Национальная ассоциация пенальти · часть сборов направлена на покупку инвалидной коляски ребёнку" }
  ];
